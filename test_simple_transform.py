...
silver_path = f"s3://{bucket}/silver/year={year}/month={month}/day={day}/clean_prices.parquet"
...
try:
    con.execute(f"COPY ({full_silver_query}) TO '{silver_path}' (FORMAT PARQUET, OVERWRITE_OR_IGNORE true)")
